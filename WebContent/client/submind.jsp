...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="${pageContext.request.contextPath }/mutualResource/${pageContext.request.contextPath }/mutualResource/assets/css/bootstrap.min.css" rel="stylesheet" />
        <link rel="stylesheet" href="${pageContext.request.contextPath }/mutualResource/css/style.css"/>       
        <link href="${pageContext.request.contextPath }/mutualResource/${pageContext.request.contextPath }/mutualResource/assets/css/codemirror.css" rel="stylesheet">
        ...
        <script src="${pageContext.request.contextPath }/mutualResource/assets/${pageContext.request.contextPath }/mutualResource/js/bootstrap.min.js"></script>
		<script src="${pageContext.request.contextPath }/mutualResource/assets/${pageContext.request.contextPath }/mutualResource/js/typeahead-bs2.min.js"></script> 
        <script type="text/javascript" src="${pageContext.request.contextPath }/mutualResource/js/H-ui.js"></script>      	
		<script src="${pageContext.request.contextPath }/mutualResource/assets/${pageContext.request.contextPath }/mutualResource/js/jquery.dataTables.min.js"></script>
		<script src="${pageContext.request.contextPath }/mutualResource/assets/${pageContext.request.contextPath }/mutualResource/js/jquery.dataTables.bootstrap.js"></script>
        ...
        <script src="${pageContext.request.contextPath }/mutualResource/assets/${pageContext.request.contextPath }/mutualResource/js/jquery.easy-pie-chart.min.js"></script>
...
<div class="Numbering"><b>可预约咨询师:</b></div></div>
 <div class="detailed_style">
    ...
    <div class="product_info clearfix">
     <a href="#" class="img_link"><img src="/upload/${doctor.img}"  width="200" height="200"/></a>
      ...
      <a href="${pageContext.request.contextPath }/client/ClientSubServlet?m=subStep1" id="member_add" class="btn btn-warning">我要预约</a>
